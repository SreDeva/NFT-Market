...
contract NFTMarketplace is ERC721URIStorage{
    ...
    modifier onlyOwner{
        require(msg.sender == owner, "only owner of the contract or marketplace can change the price");
        _;
    }
...
//Create Market Items
    ...
    function reSellToken(uint256 tokenId, uint256 price) public payable{
        ...
        require(msg.value == listingPrice, "price must be equal to");
